...
export namespace HasteHealthTenantCustomization {
  export type Input = { name?: fhirTypes.string; logo?: fhirTypes.Attachment };
  export type Output = Record<string, never>;
  export type IOp = IOperation<Input, Output>;
  export const Op: IOp = new Operation<Input, Output>({
    resourceType: "OperationDefinition",
    id: "haste-health-tenant-customization",
    url: "https://haste.health/OperationDefinition/tenant-customization",
    version: "4.0.1",
    name: "Tenant Customization",
    status: "draft",
    kind: "operation",
    date: "2026-08-21T09:29:23+11:00",
    publisher: "HasteHealth",
    description:
      "Set display customization for the current tenant, such as its display name and logo.",
    code: "tenant-customization",
    system: true,
    type: false,
    instance: false,
    parameter: [
      {
        ...
        max: "1",
        documentation:
          "Display name for the tenant. Omit to clear the tenant's display name.",
        type: "string",
      },
      {
        name: "logo",
        ...
        min: 0,
        max: "1",
        documentation: "Logo for the tenant. Omit to clear the tenant's logo.",
        type: "Attachment",
      },
    ],
  } as fhirTypes.OperationDefinition);
}
export namespace HasteHealthTenantBranding {
  export type Input = Record<string, never>;
  export type Output = { name?: fhirTypes.string; logo?: fhirTypes.Attachment };
  export type IOp = IOperation<Input, Output>;
  export const Op: IOp = new Operation<Input, Output>({
    resourceType: "OperationDefinition",
    id: "haste-health-tenant-branding",
    url: "https://haste.health/OperationDefinition/tenant-branding",
    version: "4.0.1",
    ...
    publisher: "HasteHealth",
    description: "Get the current tenant's display name and logo, if set.",
    ...
    parameter: [
      {
        ...
        min: 0,
        max: "1",
        documentation: "Display name for the tenant, if one has been set.",
        type: "string",
      },
      {
        name: "logo",
        ...
        min: 0,
        max: "1",
        documentation: "Logo for the tenant, if one has been set.",
        type: "Attachment",
      },
    ],
  } as fhirTypes.OperationDefinition);
