        ...
        <>
          ...
          <SideBarItem logo={<InboxArrowDownIcon />}>
            <div className="flex">
              ...
              <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-teal-800 bg-teal-200 rounded-full dark:bg-teal-900 dark:text-teal-300">
                3
              </span>
            </div>
          </SideBarItem>
