...
id: gemini
title: "Gemini"
description: Step-by-step guide to connect the Gemini CLI to Haste Health's FHIR data via the Model Context Protocol and OAuth 2.0 authorization.
sidebar_position: 2
tags:
  - authentication
  - AI applications
...
For more information, see [Scopes documentation](/docs/auth/authorization/scopes).
...
- [Client Registration](/docs/auth/authentication/client_registration) - Complete ClientApplication documentation
- [OAuth 2.0 Authorization codes](/docs/auth/authentication/grant_types/authorization_code) - Authentication code grant details
- [OAuth 2.0 Refresh tokens](/docs/auth/authentication/grant_types/refresh_token) - Refresh token grant details
- [Scopes](/docs/auth/authorization/scopes) - OAuth scope configuration
