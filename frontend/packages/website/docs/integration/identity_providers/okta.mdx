...
id: okta
title: "Okta"
description: Step-by-step guide to configure Okta as an OIDC identity provider for federated login into a Haste Health project.
sidebar_position: 1
tags:
  - authentication
  - oidc
...
2. **Copy Configuration information**
    ...
    - Use the following URLs:
      ...
      - **OAuth 2.0 token endpoint (v2)**: `https://[your-okta-tenant-domain]/oauth2/v1/token`
