...
description: How to run Haste Health locally with Docker Compose and log in to the default admin interface in about five minutes.
sidebar_position: 0
---
...
- [Authentication](/docs/category/oauth-grant-types)
