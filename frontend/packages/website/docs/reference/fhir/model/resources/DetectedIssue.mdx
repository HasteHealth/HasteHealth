...
id: DetectedIssue
title: DetectedIssue
description: "DetectedIssue (FHIR R4 resource): Reference documentation for the FHIR R4 DetectedIssue resource: structure, elements, and search parameters."
...
<head>
  ...
  <meta name="description" content="DetectedIssue (FHIR R4 resource): Reference documentation for the FHIR R4 DetectedIssue resource: structure, elements, and search parameters." />
  ...
  ## Structure
  <BrowserOnly> {() => <StructureDefinitionDisplay sd="DetectedIssue" />}</BrowserOnly>
  </div>
...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-brand-900 line-clamp-3 truncate"> <span>Problem resource</span></div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-brand-900 line-clamp-3 truncate"> <span>The provider or device that identified the issue</span></div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-brand-900 line-clamp-3 truncate"> <span>When identified</span></div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-brand-900 line-clamp-3 truncate"> <span>Issue Category, e.g. drug-drug, duplicate therapy, etc.</span></div>
        <div class="line-clamp-3 truncate">
