---
title: SQL on FHIR
description: How to use SQL on FHIR ViewDefinitions in Haste Health to flatten FHIR resources into tabular CSV, JSON, or NDJSON rows for analytics.
sidebar_position: 2
tags:
    - core concepts
    - sql on fhir
...
```bash
curl -X POST "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/\$viewdefinition-run" \
