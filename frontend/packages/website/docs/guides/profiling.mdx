...
description: How Haste Health validates FHIR resources against StructureDefinition profiles like US Core, including cardinality, fixed values, and slicing.
tags:
    - core concepts
    - profiling
    - validation
