...
For more information, see [Scopes documentation](/docs/APIs%20&%20SDKs/Authorization/scopes).
...
- [Client Registration](/docs/APIs%20&%20SDKs/Authentication/Client%20Registration) - Complete ClientApplication documentation
- [OAuth 2.0 Authorization codes](/docs/APIs%20&%20SDKs/Authentication/OpenID%20Connect/authorization-code) - Authentication code grant details
- [OAuth 2.0 Refresh tokens](/docs/APIs%20&%20SDKs/Authentication/OpenID%20Connect/refresh-token) - Refresh token grant details
- [Scopes](/docs/APIs%20&%20SDKs/Authorization/scopes) - OAuth scope configuration
- [Model Context Protocol](/docs/APIs%20&%20SDKs/Rest%20API/Model%20Context%20Protocol/Endpoint) - MCP overview and setup
