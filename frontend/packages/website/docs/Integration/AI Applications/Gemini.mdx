...
| **Secret** | (auto-generated) | Client secret for authentication |
...
For more information, see [Scopes documentation](/docs/Authentication/Scopes).

## Step 2: Install Gemini CLI.

1. Run `npm install -g @google/gemini-cli` to install the Gemini CLI.

## Step 3: Configure MCP Server for OAuth
...
"mcpServers": {
    "haste-health": {
      "httpUrl": "https://local.haste.health/w/ohio-health/5nst9f43/api/v1/mcp",
...
- [Client Registration](/docs/Authentication/Client%20Registration) - Complete ClientApplication documentation
- [OAuth 2.0 Authorization codes](/docs/Authentication/OpenID%20Connect/authorization-code) - Authentication code grant details
- [OAuth 2.0 Refresh tokens](/docs/Authentication/OpenID%20Connect/refresh-token) - Refresh token grant details
- [Scopes](/docs/Authentication/Scopes) - OAuth scope configuration
- [Model Context Protocol](/docs/API/Model%20Context%20Protocol/Endpoint) - MCP overview and setup
...
5. Contact Haste Health support with log files and configuration (redact secrets!)
6. File an issue on the [Haste Health GitHub repository](https://github.com/haste-health/haste_health/issues)
