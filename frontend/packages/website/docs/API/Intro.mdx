...
```
https://api.haste.health/w/{tenant}/api/v1/{project}/fhir/{version}
```

**Example:**
```
https://api.haste.health/w/acme-health/api/v1/production/fhir/r4
```
...
Projects are defined using the custom FHIR **[Project](/docs/api/fhir/model/resources/project)** resource type with the following key properties:
...
**[View IdentityProvider Documentation →](/docs/api/fhir/model/resources/identityprovider)**
...
```http
POST /w/{tenant}/api/v1/system/fhir/r4/Project
...
GET /w/acme-health/api/v1/production/fhir/r4/Patient

# Access staging project
GET /w/acme-health/api/v1/staging/fhir/r4/Patient
```
...
```http
GET /w/{tenant}/api/v1/system/fhir/r4/Project
```
...
```http
DELETE /w/{tenant}/api/v1/system/fhir/r4/Project/cardiology
```
...
```
https://api.haste.health/w/{tenant}/api/v1/{project}/fhir/{version}/{resourceType}/{id}
                              ↓              ↓                ↓           ↓          ↓         
...
```
https://api.haste.health/w/acme-health/api/v1/production/fhir/r4/Patient/123
```

**User in system project:**
```
https://api.haste.health/w/acme-health/api/v1/system/fhir/r4/User/user-456
```

**Search in specific project:**
```
https://api.haste.health/w/acme-health/api/v1/cardiology/fhir/r4/Observation?patient=Patient/123
```
