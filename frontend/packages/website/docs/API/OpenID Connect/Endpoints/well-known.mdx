...
```
GET /w/[tenant]/api/v1/[project]/oidc/.well-known/openid-configuration
```
...
```json
{
  ...
  "authorization_endpoint": "http://api.haste.health/w/ohio-health/api/v1/system/oidc/auth/authorize",
  "jwks_uri": "http://api.haste.health/w/ohio-health/api/v1/system/oidc/certs/jwks",
  "token_endpoint": "http://api.haste.health/w/ohio-health/api/v1/system/oidc/auth/token",
  "scopes_supported": [
    "openid",
    "profile",
    "email",
...
```bash
curl -X GET "http://api.haste.health/w/[tenant]/api/v1/[project]/oidc/.well-known/openid-configuration" \
...
const response = await fetch('http://api.haste.health/w/[tenant]/api/v1/[project]/oidc/.well-known/openid-configuration');
