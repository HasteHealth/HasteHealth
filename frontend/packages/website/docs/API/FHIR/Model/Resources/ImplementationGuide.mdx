...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Identity of the IG that this depends on</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Profile that all resources must conform to</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Location of the resource</div>
        <div class="line-clamp-3 truncate">
