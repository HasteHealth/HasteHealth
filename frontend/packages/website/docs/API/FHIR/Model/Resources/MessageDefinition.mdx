...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The behavior associated with the message</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The event that triggers the message or link to the event definition.</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">A resource that is a permitted focus of the message</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">A resource that is the parent of the definition</div>
        <div class="line-clamp-3 truncate">
