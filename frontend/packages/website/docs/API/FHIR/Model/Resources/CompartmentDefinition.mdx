...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Patient / Encounter / RelatedPerson / Practitioner / Device</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Name of resource type</div>
        <div class="line-clamp-3 truncate">
