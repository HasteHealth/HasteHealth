...
```bash
haste-health api invoke_instance r4 Patient 12345 everything --file params.json
```
...
```bash
curl -X POST "https://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/Patient/12345/\$everything" \
