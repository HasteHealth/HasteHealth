...
```json
{
  ...
  "entry": [
    ...
    {
      "fullUrl": "http://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/Observation/67890/_history/1",
      "resource": {
...
```bash
curl -X GET "http://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/_history?_count=50&_since=2025-01-01" \
