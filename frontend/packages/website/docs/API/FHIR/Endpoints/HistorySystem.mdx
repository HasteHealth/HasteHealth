...
```bash
haste-health api history_system r4 "_count=50&_since=2025-01-01"
```
...
```bash
haste-health api history_system r4
```
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/_history?_count=50&_since=2025-01-01" \
