...
```bash
haste-health api search_system r4 "_type=Patient,Observation&_lastUpdated=ge2025-01-01"
```
...
```bash
haste-health api search_system r4
```
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4?_type=Patient,Observation&_lastUpdated=ge2025-01-01" \
