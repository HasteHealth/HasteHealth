...
```json
{
  ...
  "parameter": [
    ...
    {
      "name": "request",
      "valueUri": "http://api.haste.health/$export?_type=Patient"
    },
    {
    ...
    },
    {
      ...
      "part": [
        ...
        {
          "name": "url",
          "valueUrl": "http://api.haste.health/bulk-data/export-123/Patient.ndjson"
        }
      ]
    }
  ]
...
```bash
curl -X POST "http://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/\$export" \
