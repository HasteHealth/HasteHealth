...
```bash
haste-health api delete-type Patient 12345
```
...
```bash
curl -X DELETE "https://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/Patient?identifier=http://example.org/fhir/ids|12345" \
