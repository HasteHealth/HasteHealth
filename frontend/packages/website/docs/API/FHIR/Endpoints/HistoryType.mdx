...
```json
{
  ...
  "entry": [
    ...
    {
      "fullUrl": "http://localhost:3000/w/[tenant]/api/v1/[project]/fhir/r4/Patient/67890/_history/1",
      "resource": {
        "resourceType": "Patient",
        "id": "67890",
        "meta": {
...
```bash
curl -X GET "http://localhost:3000/w/[tenant]/api/v1/[project]/fhir/r4/Patient/_history?_count=20&_since=2025-01-01" \
