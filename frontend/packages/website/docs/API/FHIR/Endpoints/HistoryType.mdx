...
```bash
haste-health api history_type r4 Patient "_count=20&_since=2025-01-01"
```
...
```bash
haste-health api history_type r4 Patient
```
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/api/v1/[project]/fhir/r4/Patient/_history?_count=20&_since=2025-01-01" \
