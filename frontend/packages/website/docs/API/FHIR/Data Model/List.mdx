...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        <div class="text-sm">
            <span class="font-semibold">empty-reason</span> <span> (token)</span>
        </div>
        <div class="text-orange-900 line-clamp-3 truncate">Why list is empty</div>
        <div class="line-clamp-3 truncate">
              <code>List.emptyReason</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Actual entry</div>
        <div class="line-clamp-3 truncate">
              <code>List.entry.item</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        <div class="text-sm">
            <span class="font-semibold">notes</span> <span> (string)</span>
        </div>
        <div class="text-orange-900 line-clamp-3 truncate">The annotation  - text content (as markdown)</div>
        <div class="line-clamp-3 truncate">
              <code>List.note.text</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Who and/or what defined the list contents (aka Author)</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">current / retired / entered-in-error</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">If all resources have the same subject</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Descriptive name for the list</div>
        <div class="line-clamp-3 truncate">
