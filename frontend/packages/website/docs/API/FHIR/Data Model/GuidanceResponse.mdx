...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The identifier of the guidance response</div>
        <div class="line-clamp-3 truncate">
              <code>GuidanceResponse.identifier</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The identity of a patient to search for guidance response results</div>
        <div class="line-clamp-3 truncate">
              <code>GuidanceResponse.subject.where(resolve() is Patient)</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        <div class="text-sm">
            <span class="font-semibold">request</span> <span> (token)</span>
        </div>
        <div class="text-orange-900 line-clamp-3 truncate">The identifier of the request associated with the response</div>
        <div class="line-clamp-3 truncate">
              <code>GuidanceResponse.requestIdentifier</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The subject that the guidance response is about</div>
        <div class="line-clamp-3 truncate">
