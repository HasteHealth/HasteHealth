...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The medication for which this is an undesirable effect</div>
        <div class="line-clamp-3 truncate">
              <code>MedicinalProductUndesirableEffect.subject</code>
            </div>
    </div>
