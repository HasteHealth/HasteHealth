...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Whether the practitioner record is active</div>
        <div class="line-clamp-3 truncate">
              <code>Practitioner.active</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        <div class="text-sm">
            <span class="font-semibold">communication</span> <span> (token)</span>
        </div>
        <div class="text-orange-900 line-clamp-3 truncate">One of the languages that the practitioner can communicate with</div>
        <div class="line-clamp-3 truncate">
              <code>Practitioner.communication</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="line-clamp-3 truncate">
              <code>Practitioner.identifier</code>
            </div>
    </div>
