...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The business identifier of the Enrollment</div>
        <div class="line-clamp-3 truncate">
              <code>EnrollmentRequest.identifier</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The party to be enrolled</div>
        <div class="line-clamp-3 truncate">
              <code>EnrollmentRequest.candidate</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The status of the enrollment</div>
        <div class="line-clamp-3 truncate">
              <code>EnrollmentRequest.status</code>
            </div>
    </div>
