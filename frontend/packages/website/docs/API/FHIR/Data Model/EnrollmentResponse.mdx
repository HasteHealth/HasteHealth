...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The business identifier of the EnrollmentResponse</div>
        <div class="line-clamp-3 truncate">
              <code>EnrollmentResponse.identifier</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">The status of the enrollment response</div>
        <div class="line-clamp-3 truncate">
              <code>EnrollmentResponse.status</code>
            </div>
    </div>
