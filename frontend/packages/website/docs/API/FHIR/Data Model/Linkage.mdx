...
<div class="space-y-4"> 
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Author of the Linkage</div>
        <div class="line-clamp-3 truncate">
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Matches on any item in the Linkage</div>
        <div class="line-clamp-3 truncate">
              <code>Linkage.item.resource</code>
            </div>
    </div>
    ...
    <div class="text-xs space-y-1">
        ...
        <div class="text-orange-900 line-clamp-3 truncate">Matches on any item in the Linkage with a type of 'source'</div>
        <div class="line-clamp-3 truncate">
              <code>Linkage.item.resource</code>
            </div>
    </div>
