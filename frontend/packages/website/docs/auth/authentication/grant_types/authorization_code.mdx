...
description: How the OAuth 2.0 authorization code grant with PKCE works in Haste Health, for single-page apps, mobile apps, and other public clients.
sidebar_position: 1
tags:
  - authentication
  - oidc
...
sequenceDiagram
    ...
    SPA->>AuthServer: POST /w/{tenant}/{project}/api/v1/oidc/auth/token
    ...
    rect rgb(240, 248, 255)
        ...
        SPA->>API: GET /w/{tenant}/{project}/api/v1/fhir/Patient<br/>Authorization: Bearer ACCESS_TOKEN
...
**Request:**
```http
GET /w/{tenant}/{project}/api/v1/fhir/Patient/123 HTTP/1.1
Host: api.haste.health
