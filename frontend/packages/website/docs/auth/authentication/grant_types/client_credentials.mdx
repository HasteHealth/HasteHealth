...
description: How the OAuth 2.0 client credentials grant enables machine-to-machine authentication in Haste Health for backend services and automated jobs.
sidebar_position: 2
tags:
  - authentication
  - oidc
...
sequenceDiagram
    ...
    App->>AuthServer: POST /w/{tenant}/{project}/api/v1/oidc/auth/token
    ...
    rect rgb(240, 248, 255)
        ...
        App->>API: GET /w/{tenant}/{project}/api/v1/fhir/Patient<br/>Authorization: Bearer ACCESS_TOKEN
    ...
    rect rgb(255, 250, 240)
        ...
        App->>AuthServer: POST /w/{tenant}/{project}/api/v1/oidc/auth/token<br/>(request new token)
...
```http
POST /w/{tenant}/{project}/api/v1/oidc/auth/token HTTP/1.1
...
**Request:**
```http
GET /w/{tenant}/{project}/api/v1/fhir/Patient HTTP/1.1
Host: api.haste.health
