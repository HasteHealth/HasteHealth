---
title: Intro
description: An overview of Haste Health's layered authorization model, combining OAuth 2.0 scopes, role-based access control, and attribute-based access control.
sidebar_position: 0
tags:
  - authorization
---
...
- **[Scopes & Permissions](/docs/auth/authorization/scopes)**: OAuth scopes and SMART on FHIR
- **[Membership](/docs/auth/authorization/membership)**: User-to-Project linking and roles
- **[Access Control](/docs/auth/authorization/access_control)**: AccessPolicyV2 and policy engines
- **[Authentication](/docs/category/oauth-grant-types)**: OAuth flows and token management
- **[SMART on FHIR](/docs/auth/authentication/smart_on_fhir)**: Healthcare app authorization