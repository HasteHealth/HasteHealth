...
description: Reference for Haste Health's OIDC and SMART on FHIR scope system, including scope syntax, permission characters, and example scope combinations.
sidebar_position: 4
tags:
  - authentication
  - authorization
