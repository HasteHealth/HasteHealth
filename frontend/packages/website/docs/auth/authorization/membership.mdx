---
title: Membership
description: How the Membership resource links Users to Projects in Haste Health and works with AccessPolicyV2 to control project-level access.
sidebar_position: 2
tags:
  - authorization
---
...
Memberships are assigned **AccessPolicyV2** resources, which determine what resources a user has access to within a project, through `AccessPolicyV2Assignment`:

```json
{
  "resourceType": "AccessPolicyV2Assignment",
  "accessPolicy": {
    "reference": "AccessPolicyV2/admin"
  },
  "link": {
