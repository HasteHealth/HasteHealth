...
https://app.example.com/launch?
  iss=https://api.haste.health/w/{tenant}/api/v1/{project}/fhir/r4
...
```json
{
  ...
  "authorization_endpoint": "https://api.haste.health/w/{tenant}/api/v1/oauth/authorize",
  "token_endpoint": "https://api.haste.health/w/{tenant}/api/v1/oauth/token",
  "token_endpoint_auth_methods_supported": [
    "client_secret_basic",
    "client_secret_post",
    "private_key_jwt"
  ],
  "registration_endpoint": "https://api.haste.health/w/{tenant}/api/v1/oauth/register",
  "scopes_supported": [
    "openid",
    "profile",
    "email",
