...
Learn more: [Authorization Code Flow](/docs/Authentication/OpenID%20Connect/Authorization%20Code)
...
Learn more: [Client Credentials Flow](/docs/Authentication/OpenID%20Connect/Client%20Credentials)
...
Learn more: [Refresh Token Flow](/docs/Authentication/OpenID%20Connect/Refresh%20Token)
...
Learn more about our support for [SMART on FHIR](/docs/Authentication/SMART%20on%20FHIR)

## Federated Login

Connect external identity providers for Single Sign-On (SSO):

Learn more about our support for [Federated Login](/docs/Authentication/Federated%20Login)
...
1. **Register a Client Application**
   see [Client Registration](/docs/Authentication/Client%20Registration)
...
3. **Implement Authentication Flow**
   - See [Authorization Code Flow](/docs/Authentication/OpenID%20Connect/authorization-code) for web apps
   - See [Client Credentials Flow](/docs/Authentication/OpenID%20Connect/client-credentials) for backend services
...
### Core Concepts
- [Client Registration](/docs/Authentication/Client%20Registration) - Register OAuth clients
- [Scopes](/docs/Authentication/Scopes) - OAuth scope configuration

### Authentication Flows
- [Authorization Code](/docs/Authentication/OpenID%20Connect/authorization-code) - User authentication flow
- [Client Credentials](/docs/Authentication/OpenID%20Connect/client-credentials) - Machine-to-machine auth
- [Refresh Token](/docs/Authentication/OpenID%20Connect/refresh-token) - Token refresh flow

### Advanced Topics
- [SMART on FHIR](/docs/Authentication/smart-on-fhir) - Healthcare-specific authorization
- [Federated Login](/docs/Authentication/Federated%20Login) - External identity provider integration
- [Access Control](/docs/Authorization/Access%20Control) - Fine-grained permissions
