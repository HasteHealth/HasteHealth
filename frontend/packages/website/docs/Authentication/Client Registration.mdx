...
The server will auto-generate a secure `secret` if not provided. Retrieve the generated secret:
...
- [Client Credentials Grant](/docs/Authentication/OpenID%20Connect/Client%20Credentials) - Machine-to-machine authentication
- [Authorization Code Flow](/docs/Authentication/OpenID%20Connect/Authorization%20Code) - User authentication flow
- [SMART on FHIR](/docs/Authentication/SMART%20on%20FHIR) - Healthcare-specific authorization
- [Access Control](/docs/category/access-control) - Configuring client permissions
