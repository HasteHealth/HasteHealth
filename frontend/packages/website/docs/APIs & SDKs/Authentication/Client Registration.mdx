...
See [Scopes documentation](/docs/APIs%20&%20SDKs/Authorization/scopes) for complete scope syntax.
...
- [Scopes Documentation](/docs/APIs%20&%20SDKs/Authorization/scopes) - OAuth scope syntax and usage
- [Client Credentials Grant](/docs/APIs%20&%20SDKs/Authentication/OpenID%20Connect/client-credentials) - Machine-to-machine authentication
- [Authorization Code Flow](/docs/APIs%20&%20SDKs/Authentication/OpenID%20Connect/authorization-code) - User authentication flow
- [SMART on FHIR](/docs/APIs%20&%20SDKs/Authentication/smart-on-fhir) - Healthcare-specific authorization
- [Access Control](/docs/APIs%20&%20SDKs/Authorization/Intro) - Configuring client permissions
