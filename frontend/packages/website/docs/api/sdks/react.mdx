---
title: React
description: Reference for the @haste-health/components React library, with base UI, layout, and FHIR-aware components like FHIRGenerativeForm and FHIRSearchTable.
sidebar_position: 3
tags:
  - components
  - react
