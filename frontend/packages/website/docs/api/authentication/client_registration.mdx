...
- [Client Credentials Grant](/docs/api/authentication/openid_connect/client_credentials) - Machine-to-machine authentication
- [Authorization Code Flow](/docs/api/authentication/openid_connect/authorization_code) - User authentication flow
