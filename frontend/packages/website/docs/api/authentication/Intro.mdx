...
Learn more: [Authorization Code Flow](/docs/api/authentication/openid_connect/authorization_code)
...
Learn more: [Client Credentials Flow](/docs/api/authentication/openid_connect/client_credentials)
...
Learn more: [Refresh Token Flow](/docs/api/authentication/openid_connect/refresh_token)
...
Learn more about our support for [SMART on FHIR](/docs/api/authentication/smart_on_fhir)

## Federated Login

Connect external identity providers for Single Sign-On (SSO):

Learn more about our support for [Federated Login](/docs/api/authentication/federated_login)
...
1. **Register a Client Application**
   see [Client Registration](/docs/api/authentication/client_registration)
...
3. **Implement Authentication Flow**
   - See [Authorization Code Flow](/docs/api/authentication/openid_connect/authorization_code) for web apps
   - See [Client Credentials Flow](/docs/api/authentication/openid_connect/client_credentials) for backend services
...
- [Authorization Code](/docs/api/authentication/openid_connect/authorization_code) - User authentication flow
- [Client Credentials](/docs/api/authentication/openid_connect/client_credentials) - Machine-to-machine auth
- [Refresh Token](/docs/api/authentication/openid_connect/refresh_token) - Token refresh flow

### Advanced Topics
- [SMART on FHIR](/docs/api/authentication/smart_on_fhir) - Healthcare-specific authorization
- [Federated Login](/docs/api/authentication/federated_login) - External identity provider integration
- [Access Control](/docs/api/authorization/access_control) - Fine-grained permissions
