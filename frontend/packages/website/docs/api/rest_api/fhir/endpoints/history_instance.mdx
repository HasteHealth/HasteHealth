...
description: How to retrieve the version history of a specific FHIR resource instance using the CLI, TypeScript client, or cURL.
sidebar_position: 9
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/Patient/12345/_history?_count=10" \
