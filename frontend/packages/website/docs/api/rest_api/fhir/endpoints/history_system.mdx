...
description: How to retrieve the system-wide change history across all FHIR resource types using the CLI, TypeScript client, or cURL.
sidebar_position: 11
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/_history?_count=50&_since=2025-01-01" \
