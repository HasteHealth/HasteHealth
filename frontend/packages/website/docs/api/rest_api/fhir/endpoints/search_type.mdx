...
id: search-type
title: search-type
description: How to search for FHIR resources of a specific type matching search criteria using the CLI, TypeScript client, or cURL.
sidebar_position: 7
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/Patient?name=Smith&birthdate=ge1980-01-01" \
