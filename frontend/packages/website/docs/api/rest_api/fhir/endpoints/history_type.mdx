...
id: history-type
title: history-type
description: How to retrieve the version history for all FHIR resources of a specific type using the CLI, TypeScript client, or cURL.
sidebar_position: 10
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/Patient/_history?_count=20&_since=2025-01-01" \
