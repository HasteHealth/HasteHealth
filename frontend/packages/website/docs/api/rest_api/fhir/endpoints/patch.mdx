...
id: patch
title: patch
description: How to partially update a FHIR resource using JSON Patch or FHIRPath Patch, via the CLI, TypeScript client, or cURL.
sidebar_position: 4
---
...
```bash
curl -X PATCH "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/Patient/12345" \
