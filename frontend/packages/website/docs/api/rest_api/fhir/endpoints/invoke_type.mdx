...
id: invoke-type
title: invoke-type
description: How to invoke a custom or standard FHIR operation on a resource type, such as $expand on ValueSet, using the CLI or cURL.
sidebar_position: 13
---
...
```bash
curl -X POST "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/ValueSet/\$expand" \
