...
id: read
title: read
description: How to retrieve a specific FHIR resource instance by ID using the CLI, TypeScript client, or cURL.
sidebar_position: 1
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/Patient/12345" \
