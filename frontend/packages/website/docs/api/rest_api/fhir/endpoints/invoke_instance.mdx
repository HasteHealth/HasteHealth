...
description: How to invoke a custom or standard FHIR operation on a specific resource instance using the CLI, TypeScript client, or cURL.
sidebar_position: 12
---
...
```bash
curl -X POST "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/IdentityProvider/my-id/\$registration-info" \
