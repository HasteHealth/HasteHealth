...
id: version-read
title: version-read
description: How to retrieve a specific historical version of a FHIR resource instance using the CLI, TypeScript client, or cURL.
sidebar_position: 2
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir/Patient/12345/_history/my-version-id" \
