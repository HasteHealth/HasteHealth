...
id: search-system
title: search-system
description: How to search across all FHIR resource types on the Haste Health server using the CLI, TypeScript client, or cURL.
sidebar_position: 8
---
...
```bash
curl -X GET "https://api.haste.health/w/[tenant]/[project]/api/v1/fhir?_sort=_lastUpdated" \
