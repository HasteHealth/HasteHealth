...
id: validate-code
title: $validate-code
description: How to use the FHIR $validate-code operation to check whether a given code is valid within a specific ValueSet.
sidebar_position: 1
---
...
```
POST /w/{tenant}/{project}/api/v1/fhir/ValueSet/$validate-code
```
