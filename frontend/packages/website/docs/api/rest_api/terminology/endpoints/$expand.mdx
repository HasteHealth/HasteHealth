...
id: expand
title: $expand
description: How to use the FHIR $expand operation to retrieve the list of codes contained in a ValueSet at a given point in time.
sidebar_position: 0
---
...
```
POST /w/{tenant}/{project}/api/v1/fhir/ValueSet/$expand
```
