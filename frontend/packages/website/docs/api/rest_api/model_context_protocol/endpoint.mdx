---
title: Endpoint
description: Reference for Haste Health's Model Context Protocol endpoint, a JSON-RPC 2.0 API that lets AI agents call FHIR operations as structured tools.
---
