...
description: How Haste Health's multi-tenant architecture isolates data using Tenants and Projects, including the special System Project for auth config.
tags:
    - architecture
    - multi-tenancy
    - projects
...
GET /w/acme-health/production/api/v1/fhir/Patient

# Access staging project
GET /w/acme-health/staging/api/v1/fhir/Patient
```
...
```
https://api.haste.health/w/acme-health/production/api/v1/fhir/Patient/123
```

**Get a User from the system project:**
```
https://api.haste.health/w/acme-health/system/api/v1/fhir/User/user-456
```

**Search in specific project:**
```
https://api.haste.health/w/acme-health/cardiology/api/v1/fhir/Observation?patient=Patient/123
```
