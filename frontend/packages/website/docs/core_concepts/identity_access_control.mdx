...
description: How Haste Health's User, Membership, and AccessPolicyV2 resources work together to manage identity and authorization across projects.
tags:
    - core concepts
    - identity
    - access
...
**Related Documentation**:
- **[View Membership details →](/docs/auth/authorization/membership)** 
...
**Related Documentation**:
- **[View AccessPolicyV2 details →](/docs/auth/authorization/access_control)**
...
**Related Documentation**:
- **[Authorization Overview](/docs/auth/authorization/intro)**: Complete authorization system
