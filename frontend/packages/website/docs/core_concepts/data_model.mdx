...
sidebar_position: 1
title: Data Model
description: An overview of Haste Health's FHIR R4 data model plus its custom resources - AccessPolicyV2, User, Project, Membership, and IdentityProvider.
tags:
    - core concepts
    - data model
---
...
**[Browse all FHIR resource types →](/docs/reference/fhir/model/resources/)**
...
Haste Health provides a FHIR API for interacting with all resources.

**[View REST API documentation →](/docs/category/endpoints)**

## Reference Documentation

For detailed schemas, search parameters, and examples for each resource type:

**[View all resources →](/docs/reference/fhir/model/resources/)**