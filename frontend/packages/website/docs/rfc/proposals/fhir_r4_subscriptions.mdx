...
Could then have multiple consumers which are partitioned by subscription_id to ensure that messages for the same subscription are processed in order.
...
Implementatino would look as follows:
