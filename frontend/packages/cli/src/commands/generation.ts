...
export function codeGenerationCommands(command: Command) {
  command
    ...
    .action(async (options) => {
      ...
      writeFileSync(
        options.output,
        "// @generated by `pnpm --filter @haste-health/meta-value run generate` - do not edit.\nexport default " +
  ...
  command
    ...
    .action((options) => {
      ...
      const generatedHeader =
        "// @generated by `pnpm --filter @haste-health/fhir-types run generate` - do not edit.\n";

      writeFileSync(
        path.join(options.output, "types.ts"),
        generatedHeader + generatedTypes
      );
      writeFileSync(
        path.join(options.output, "sets.ts"),
        generatedHeader + generatedSets
      );
    });
  ...
  command
    ...
    .action(async (options) => {
      ...
      writeFileSync(
        path.join(options.output, "ops.ts"),
