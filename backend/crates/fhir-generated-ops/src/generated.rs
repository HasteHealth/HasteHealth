...
#[doc = "unsuccessful, an [``OperationOutcome``](operationoutcome.html) with an error message will be"]
#[doc = "returned. The client can request that all the observations on which the statistics are based be"]
#[doc = "returned as well, using the include parameter. If an include parameter is specified, a limit may"]
#[doc = "also be specified; the sources observations are subsetted at the server's discretion if count >"]
#[doc = "limit. This functionality is included with the intent of supporting graphical presentation"]
...
pub mod ValueSetExpand {
    ...
    pub struct Input {
        ...
        #[doc = "in [`TerminologyCapabilities`](terminologycapabilities.html)..expansion.textFilter. Typical usage of"]
        #[doc = "this parameter includes functionality like:"]
        #[doc = ""]
