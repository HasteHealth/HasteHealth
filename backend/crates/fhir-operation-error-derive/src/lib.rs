...
fn derive_operation_issues(v: &Variant) -> proc_macro2::TokenStream {
    ...
    let invariant_operation_outcome_issues = issues.iter().map(|simple_issue: &SimpleIssue| {
        ...
        let severity = quote!{ Box::new(oxidized_fhir_model::r4::generated::terminology::IssueSeverity::Fatal(None)) };
        ...
        let code = quote! {
            Box::new(oxidized_fhir_model::r4::generated::terminology::IssueType::Exception(None))
        };
