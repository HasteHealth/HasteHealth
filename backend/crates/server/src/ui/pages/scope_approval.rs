                ...
                div class="p-6 space-y-4 md:space-y-6 sm:p-8" {
                    ...
                    div class="justify-center items-center flex space-x-4" {
                        form action=(scope_route_str) method="POST" {
                            ...
                            button type="submit" class="cursor-pointer w-full text-white bg-brand-500 hover:bg-brand-500 focus:ring-4 focus:outline-none focus:ring-brand-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-brand-500 dark:hover:bg-brand-500 dark:focus:ring-brand-800" {
                                "Allow"
                            }
                        }
